...
public class IniSection {
	 ...
	 * The section's tag
	 */
	private String _tag; //Identificador de la seccion(new_junction, new_vehicle...)

	/**
	 * Key-Value mapping
	 */
	private Map<String, String> _attr; //Contiene cada entrada de la seccion (timpe, 0) (max_speed, 10)
	 ...
	 */
	public String getTag() { //Devuelve new_vehicle, new_road...
		return _tag;
	}
	 ...
	 *            The value
	 */
	public void setValue(String key, Object value) { //Coloca en key, el valor value
	 ...
	 */
	public String getValue(String key) { //Devuelve el valor asociado a key, por ejemplo con key = "max_speed" devolveria el valor de max_speed
